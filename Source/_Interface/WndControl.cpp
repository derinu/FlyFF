...
BOOL CWndStatic::Create( LPCTSTR lpszCaption, DWORD dwStyle, const RECT& rect, CWndBase* pParentWnd, UINT nID )	
{
	...
	if( !(dwStyle & WSS_GROUPBOX) )
	{
		...
		m_dwColor = 0xffeedd82;//Adeilson 0xff2e70a9;
	}
...
*/	
	...
	if(m_dwStyle & WBS_RADIO)
	{
        ...
        m_nHighlightColor = D3DCOLOR_ARGB( 255, 170, 170, 170 );
#endif// __BUTTONS_V19
...
m_lpParent( NULL ), 
m_dwColor( D3DCOLOR_ARGB( 255, 255, 255, 255 ) ), /*adeilson*/
m_dwSelectColor( D3DCOLOR_ARGB( 255, 0, 255, 255 ) ),/*adeilson*/ 
m_strKeyword( _T( "" ) ), 
m_dwData( 0 ), 
m_bOpen( FALSE ), 
m_pWndCheckBox( NULL )
