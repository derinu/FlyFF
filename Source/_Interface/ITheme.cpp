...
void CTheme::RenderWndButton( C2DRender* p2DRender, CWndButton* pWndButton  )
{
	...
	DWORD dwColor1 = ( bPush ?	D3DCOLOR_ARGB( 255,  0,   0,   0 ) : D3DCOLOR_ARGB( 255,  0,   0,   0 ) );
	DWORD dwColor2 = ( bPush ?	D3DCOLOR_ARGB(  50,  0,   0,   0 ) : D3DCOLOR_ARGB( 255,  0,   0,   0 ) );
	DWORD dwColor3 = ( bPush ?	D3DCOLOR_ARGB( 200,  0,   0,   0 ) : D3DCOLOR_ARGB( 255,  0,   0,   0 ) );
