...
{ 
	...
	pUser->AddBuff(BUFF_SKILL, SI_ASS_HEAL_PATIENCE			, 20, 172800);
	pUser->AddBuff(BUFF_SKILL, SI_ASS_CHEER_QUICKSTEP		, 20, 172800);
	pUser->AddBuff(BUFF_SKILL, SI_ASS_CHEER_HASTE			, 20, 172800);
	pUser->AddBuff(BUFF_SKILL, SI_ASS_CHEER_CATSREFLEX		, 20, 172800);
	pUser->AddBuff(BUFF_SKILL, SI_ASS_CHEER_CANNONBALL		, 20, 172800);
	pUser->AddBuff(BUFF_SKILL, SI_ASS_CHEER_MENTALSIGN		, 20, 172800);
	pUser->AddBuff(BUFF_SKILL, SI_ASS_CHEER_HEAPUP			, 20, 172800);
	pUser->AddBuff(BUFF_SKILL, SI_ASS_CHEER_BEEFUP			, 20, 172800);
	pUser->AddBuff(BUFF_SKILL, SI_ASS_CHEER_ACCURACY		, 20, 172800);
	pUser->AddBuff(BUFF_SKILL, SI_RIN_SUP_PROTECT			, 10, 172800);
	pUser->AddBuff(BUFF_SKILL, SI_RIN_SUP_HOLYGUARD			, 10, 172800);
	pUser->AddBuff(BUFF_SKILL, SI_RIN_SUP_SPIRITUREFORTUNE	, 10, 172800);
	pUser->AddBuff(BUFF_SKILL, SI_RIN_SQU_GEBURAHTIPHRETH	, 10, 172800);*/
#endif
	return TRUE;
}
