...
//							if(pFocusItem->GetExtra() < ((CItemElem*)pFocusItem)->m_nItemNum)
					...
					if(g_WndMng.GetWndBase( APP_SMELT_JEWEL ))
					{
						if( pProp->dwID == II_GEN_MAT_DIAMOND ||
							...
							pProp->dwID == II_GEN_MAT_EMERALD01 ||
							pProp->dwID == II_GEN_MAT_EMERALD02 ||
							pProp->dwID == II_GEN_MAT_EMERALD03 ||
							pProp->dwID == II_GEN_MAT_EMERALD04 ||
							pProp->dwID == II_GEN_MAT_EMERALD05 ||
							pProp->dwID == II_GEN_MAT_EMERALD06 ||
							pProp->dwID == II_GEN_MAT_EMERALD07 ||
							pProp->dwID == II_GEN_MAT_EMERALD08 ||
							pProp->dwID == II_GEN_MAT_EMERALD09 ||
							
							pProp->dwID == II_GEN_MAT_SAPPHIRE01 ||
							pProp->dwID == II_GEN_MAT_SAPPHIRE02 ||
							pProp->dwID == II_GEN_MAT_SAPPHIRE03 ||
							pProp->dwID == II_GEN_MAT_SAPPHIRE04 ||
							pProp->dwID == II_GEN_MAT_SAPPHIRE05 ||
							pProp->dwID == II_GEN_MAT_SAPPHIRE06 ||
							pProp->dwID == II_GEN_MAT_SAPPHIRE07 ||
							pProp->dwID == II_GEN_MAT_SAPPHIRE08 ||
							pProp->dwID == II_GEN_MAT_SAPPHIRE09 ||
							
							pProp->dwID == II_GEN_MAT_RUBY01 ||
							pProp->dwID == II_GEN_MAT_RUBY02 ||
							pProp->dwID == II_GEN_MAT_RUBY03 ||
							pProp->dwID == II_GEN_MAT_RUBY04 ||
							pProp->dwID == II_GEN_MAT_RUBY05 ||
							pProp->dwID == II_GEN_MAT_RUBY06 ||
							pProp->dwID == II_GEN_MAT_RUBY07 ||
							pProp->dwID == II_GEN_MAT_RUBY08 ||
							pProp->dwID == II_GEN_MAT_RUBY09 ||
							
							pProp->dwID == II_GEN_MAT_TOPAZ01 ||
							pProp->dwID == II_GEN_MAT_TOPAZ02 ||
							pProp->dwID == II_GEN_MAT_TOPAZ03 ||
							pProp->dwID == II_GEN_MAT_TOPAZ04 ||
							pProp->dwID == II_GEN_MAT_TOPAZ05 ||
							pProp->dwID == II_GEN_MAT_TOPAZ06 ||
							pProp->dwID == II_GEN_MAT_TOPAZ07 ||
							pProp->dwID == II_GEN_MAT_TOPAZ08 ||
							pProp->dwID == II_GEN_MAT_TOPAZ09 ||
							
							pProp->dwID == II_GEN_MAT_DIAMOND01 ||
							pProp->dwID == II_GEN_MAT_DIAMOND02 ||
							pProp->dwID == II_GEN_MAT_DIAMOND03 ||
							pProp->dwID == II_GEN_MAT_DIAMOND04 ||
							pProp->dwID == II_GEN_MAT_DIAMOND05 ||
							pProp->dwID == II_GEN_MAT_DIAMOND06 ||
							pProp->dwID == II_GEN_MAT_DIAMOND07 ||
							pProp->dwID == II_GEN_MAT_DIAMOND08 ||
							pProp->dwID == II_GEN_MAT_DIAMOND09)
						{
							if(pFocusItem->GetExtra() < ((CItemElem*)pFocusItem)->m_nItemNum)
							{			
...
void CWndNavigator::OnSize(UINT nType, int cx, int cy)
{
	...
	m_wndZoomOut.Move( CPoint(10, cy - 45 ) );//-
...
void CWndSmeltJewel::SetJewel(CItemElem* pItemElem)
{
...
#endif // __EXT_PIERCING
	{
		if(pItemElem && (pItemElem->m_dwItemId == II_GEN_MAT_RUBY || 
			...
			pItemElem->m_dwItemId == II_GEN_MAT_EMERALD01 ||
			pItemElem->m_dwItemId == II_GEN_MAT_EMERALD02 ||
			pItemElem->m_dwItemId == II_GEN_MAT_EMERALD03 ||
			pItemElem->m_dwItemId == II_GEN_MAT_EMERALD04 ||
			pItemElem->m_dwItemId == II_GEN_MAT_EMERALD05 ||
			pItemElem->m_dwItemId == II_GEN_MAT_EMERALD06 ||
			pItemElem->m_dwItemId == II_GEN_MAT_EMERALD07 ||
			pItemElem->m_dwItemId == II_GEN_MAT_EMERALD08 ||
			pItemElem->m_dwItemId == II_GEN_MAT_EMERALD09 ||

			pItemElem->m_dwItemId == II_GEN_MAT_SAPPHIRE01 ||
			pItemElem->m_dwItemId == II_GEN_MAT_SAPPHIRE02 ||
			pItemElem->m_dwItemId == II_GEN_MAT_SAPPHIRE03 ||
			pItemElem->m_dwItemId == II_GEN_MAT_SAPPHIRE04 ||
			pItemElem->m_dwItemId == II_GEN_MAT_SAPPHIRE05 ||
			pItemElem->m_dwItemId == II_GEN_MAT_SAPPHIRE06 ||
			pItemElem->m_dwItemId == II_GEN_MAT_SAPPHIRE07 ||
			pItemElem->m_dwItemId == II_GEN_MAT_SAPPHIRE08 ||
			pItemElem->m_dwItemId == II_GEN_MAT_SAPPHIRE09 ||

			pItemElem->m_dwItemId == II_GEN_MAT_RUBY01 ||
			pItemElem->m_dwItemId == II_GEN_MAT_RUBY02 ||
			pItemElem->m_dwItemId == II_GEN_MAT_RUBY03 ||
			pItemElem->m_dwItemId == II_GEN_MAT_RUBY04 ||
			pItemElem->m_dwItemId == II_GEN_MAT_RUBY05 ||
			pItemElem->m_dwItemId == II_GEN_MAT_RUBY06 ||
			pItemElem->m_dwItemId == II_GEN_MAT_RUBY07 ||
			pItemElem->m_dwItemId == II_GEN_MAT_RUBY08 ||
			pItemElem->m_dwItemId == II_GEN_MAT_RUBY09 ||

			pItemElem->m_dwItemId == II_GEN_MAT_TOPAZ01 ||
			pItemElem->m_dwItemId == II_GEN_MAT_TOPAZ02 ||
			pItemElem->m_dwItemId == II_GEN_MAT_TOPAZ03 ||
			pItemElem->m_dwItemId == II_GEN_MAT_TOPAZ04 ||
			pItemElem->m_dwItemId == II_GEN_MAT_TOPAZ05 ||
			pItemElem->m_dwItemId == II_GEN_MAT_TOPAZ06 ||
			pItemElem->m_dwItemId == II_GEN_MAT_TOPAZ07 ||
			pItemElem->m_dwItemId == II_GEN_MAT_TOPAZ08 ||
			pItemElem->m_dwItemId == II_GEN_MAT_TOPAZ09 ||

			pItemElem->m_dwItemId == II_GEN_MAT_DIAMOND01 ||
			pItemElem->m_dwItemId == II_GEN_MAT_DIAMOND02 ||
			pItemElem->m_dwItemId == II_GEN_MAT_DIAMOND03 ||
			pItemElem->m_dwItemId == II_GEN_MAT_DIAMOND04 ||
			pItemElem->m_dwItemId == II_GEN_MAT_DIAMOND05 ||
			pItemElem->m_dwItemId == II_GEN_MAT_DIAMOND06 ||
			pItemElem->m_dwItemId == II_GEN_MAT_DIAMOND07 ||
			pItemElem->m_dwItemId == II_GEN_MAT_DIAMOND08 ||
			pItemElem->m_dwItemId == II_GEN_MAT_DIAMOND09))
		{
...
void CWndBarunaNPC::OnDestroy()
{
    ...
    if( NULL !=  g_WndMng.GetWndBase( APP_BARUNA_WAKEUP ))
            g_WndMng.m_pWndBarunaWakeUp->Destroy();
    if( NULL !=  g_WndMng.GetWndBase( APP_BARUNA_WAKEUP_CANCEL ))
            g_WndMng.m_pWndBarunaWakeUpCancel->Destroy();
...
{
	CWndStatic* pWndStatic = (CWndStatic*)GetDlgItem(WIDC_PC_DELAY);
	assert(pWndStatic != NULL);
    CRect rectSmeltItem = pWndStatic->GetWndRect();
	if( m_dwEnchantTimeStart != 0xffffffff && m_dwEnchantTimeEnd != 0xffffffff )
		{
    ...
    if( m_bStart != NULL && m_bResultSwitch != false )
	{
		...
		rectStaticTemp.TopLeft().y = lpStatic->rect.top;
		rectStaticTemp.TopLeft().x = lpStatic->rect.left ;//+ ( EXTENSION_PIXEL );
		rectStaticTemp.BottomRight().y = lpStatic->rect.bottom;
		int nGaugeWidth(lpStatic->rect.left + static_cast<int>(static_cast<float>(lpStatic->rect.right - lpStatic->rect.left) * m_fGaugeRate));
		nGaugeWidth = nGaugeWidth < lpStatic->rect.right ? nGaugeWidth : lpStatic->rect.right;
		rectStaticTemp.BottomRight().x = nGaugeWidth ;//+ ( EXTENSION_PIXEL );
		assert(m_pVertexBufferGauge != NULL);
		m_pTheme->RenderGauge(p2DRender, &rectStaticTemp, 0xffffffff, m_pVertexBufferGauge, m_pNowGaugeTexture);
	}
    // m_pTexture->Render( p2DRender, CPoint( m_wndCtrl->rect.left, m_wndCtrl->rect.top ) );
}
void CWndBarunaWakeUp::OnInitialUpdate()
{
    CWndNeuz::OnInitialUpdate();

    m_wndCtrl = GetWndCtrl( WIDC_PC_BARUNA02 );
    m_wndTimeWait = GetWndCtrl( WIDC_PC_DELAY );
    CWndEdit* pWndEdit = (CWndEdit*)GetDlgItem( WIDC_ET_PENYA01 );
    CWndButton* pButton = (CWndButton*)GetDlgItem(WIDC_BT_START);
	m_pNowGaugeTexture = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, MakePath(DIR_THEME, "WndBar02.tga"), 0xffff00ff);
    pButton->EnableWindow(FALSE);

    MoveParentCenter();
}
void CWndBarunaWakeUp::StopBarunaWakeUp(void)
{
		Destroy();
}
BOOL CWndBarunaWakeUp::Process()
{
	if(m_bStart != FALSE && m_pItemElem != NULL)
	{
		...
		if(m_dwEnchantTimeEnd < g_tmCurrent)
		{
			...
			m_dwEnchantTimeStart = g_tmCurrent;
			m_dwEnchantTimeEnd = g_tmCurrent + SEC(AWAKE_TIME);
		}
	}
	else
	{
...
BOOL CWndBarunaWakeUp::Initialize( CWndBase* pWndParent, DWORD dwWndId )
{
    return CWndNeuz::InitDialog( g_Neuz.GetSafeHwnd(), APP_BARUNA_WAKEUP, 0, CPoint( 0, 0 ), pWndParent );
}
BOOL CWndBarunaWakeUp::OnCommand( UINT nID, DWORD dwMessage, CWndBase* pWndBase )
{
    return CWndNeuz::OnCommand( nID, dwMessage, pWndBase );
}
void CWndBarunaWakeUp::OnSize( UINT nType, int cx, int cy )
{
    CWndNeuz::OnSize( nType, cx, cy );
}
...
{
    CWndButton* pButton = (CWndButton*)GetDlgItem(WIDC_BUTTON1);
    CWndStatic* pWndEdit  = (CWndStatic*)GetDlgItem(WIDC_ST_PENYA);
    ...
    {        
        pTempElem  = (CItemElem*)g_pPlayer->GetItemId( pShortcut->m_dwId );
        if( pTempElem != NULL && pTempElem->GetRandomOptItemId() <= 0 )
        {
            pItemProp = pTempElem->GetProp();

		if( pTempElem->GetRandomOptItemId() == NULL)
		{
            if( pItemProp->IsBaruna() )
            {
                ...
                m_pTexture = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, MakePath( DIR_ITEM, pItemProp->szIcon), 0xffff00ff );
                m_pItemElem->SetExtra(m_pItemElem->GetExtra()+1);
                m_dwItemId = m_pItemElem->m_dwObjId;
                CWndEdit* pWndEdit = (CWndEdit*)GetDlgItem( WIDC_ET_PENYA01 );

            }
            else
                g_WndMng.OpenMessageBox( prj.GetText( TID_MMI_BARUNA_WAKEUP_E_TEXT03 ) );
		    }
        }
        else
	...
	if( m_pItemElem != NULL )
	{
		string.Format( _T( "%d" ), m_nAwaCost );//custo
	    pWndEdit->SetTitle( string );
...
{
	m_nAwaCost = 100000;
	CWndStatic* pSoF    = (CWndStatic*)GetDlgItem(WIDC_STATIC1);
    ...
    switch( nID )
    {
        case WIDC_BT_START:
			...
			if(nGoldNumber < 100000)
				...
				m_dwEnchantTimeStart = g_tmCurrent;
				m_dwEnchantTimeEnd = g_tmCurrent + SEC(AWAKE_TIME);
				CWndEdit* pWndEdit = (CWndEdit*)GetDlgItem(WIDC_ST_PENYA);
				assert(pWndEdit != NULL);
				pWndEdit->EnableWindow(FALSE);
            g_DPlay.SendBaruna( 0x08, m_dwItemId );
			}
/*			if(	g_pPlayer->GetGold() < m_nAwaCost)
			{
	           pSoF->m_dwColor     = D3DCOLOR_ARGB( 255, 255, 0, 0 );
               string.Format(prj.GetText(TID_GAME_LACKMONEY), FALSE);
			}
			else
			{
	           pSoF->m_dwColor     = D3DCOLOR_ARGB( 255, 0, 255, 0 );
               string.Format(prj.GetText(TID_GAME_AWAKENING_SUCCESS), FALSE);
		       g_DPlay.SendBaruna( 0x08, m_dwItemId );
			}
		   pSoF->SetTitle( string );*/
        case WIDC_BT_CANCEL:
        {
            Destroy();
            break;
...
void CWndBarunaWakeUpCancel::OnInitialUpdate()
{
    ...
    m_wndCtrl[0] = GetWndCtrl( WIDC_PC_BARUNA );
    m_wndCtrl[1] = GetWndCtrl( WIDC_PC_OBLIVION );  
...
BOOL CWndBarunaWakeUpCancel::Initialize( CWndBase* pWndParent, DWORD dwWndId )
{
    return CWndNeuz::InitDialog( g_Neuz.GetSafeHwnd(), APP_BARUNA_WAKEUP_CANCEL, 0, CPoint( 0, 0 ), pWndParent );
}
BOOL CWndBarunaWakeUpCancel::OnCommand( UINT nID, DWORD dwMessage, CWndBase* pWndBase )
{
    return CWndNeuz::OnCommand( nID, dwMessage, pWndBase );
}
void CWndBarunaWakeUpCancel::OnSize( UINT nType, int cx, int cy )
{
    CWndNeuz::OnSize( nType, cx, cy );
}
BOOL CWndBarunaWakeUpCancel::OnDropIcon( LPSHORTCUT pShortcut, CPoint point )
{
    ...
    {        
        pTempElem  = (CItemElem*)g_pPlayer->GetItemId( pShortcut->m_dwId );
        // Test ;)
        if( pTempElem != NULL && pTempElem->GetRandomOptItemId() >= 1  )
        {
            pItemProp = pTempElem->GetProp();
            if( pItemProp->IsBaruna() )
            {
    ...
    {        
        pTempElem  = (CItemElem*)g_pPlayer->GetItemId( pShortcut->m_dwId );
            pItemProp = pTempElem->GetProp();
            if( pItemProp->dwID == II_SYS_SYS_SCR_BARUNAOBLIVION )
            {
                if(m_pItemElem[1] != NULL)
                    m_pItemElem[1]->SetExtra(0);
...
BOOL CWndBarunaWakeUpCancel::OnChildNotify( UINT message, UINT nID, LRESULT* pLResult )
{
    switch( nID )
    {
        case WIDC_BT_START:
        {
            g_DPlay.SendBaruna( 0x09, m_dwItemId[0], m_dwItemId[1] );
            Destroy();
            break;
        }
        case WIDC_BT_CANCEL:
