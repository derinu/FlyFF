...
void MakeQuestConditionItems( DWORD dwQuestID, 
							  ...
							  DWORD dwStartColor = D3DCOLOR_ARGB( 255, 0, 0, 0 )/*adeilson*/, 
							  DWORD dwEndColor = D3DCOLOR_ARGB( 255, 0, 0, 0 )/*adeilson*/, 
							  DWORD dwSelectColor = D3DCOLOR_ARGB( 255, 0, 255, 255 ) );/*adeilson*/
const CString MakeString( const CString& string, BOOL bCond );
DWORD MakeTextColor( DWORD dwStartColor = D3DCOLOR_ARGB( 255, 0, 0, 0 )/*adeilson*/, DWORD dwEndColor = D3DCOLOR_ARGB( 255, 0, 0, 0 )/*adeilson*/, int nCurrentNumber = 0, int nCompleteNumber = 0 );
