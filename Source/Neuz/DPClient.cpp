...
void CDPClient::SendBuyItemCart( CART_ITEM pCartItem )
{
	BEFORESENDSOLE( ar, PACKETTYPE_BUYITEMCART, DPID_UNKNOWN );
...
void CDPClient::SendBaruna( BYTE nState, DWORD dwItem01,  DWORD dwItem02,  DWORD dwItem03,  DWORD dwItem04 )
{
	...
	switch( nState )
	{
        ...
        case BARUNA_WAKE_UP:            ar << dwItem01;                                     break;
        case BARUNA_WAKE_UP_CANCEL:     ar << dwItem01 << dwItem02 ;                        break;
