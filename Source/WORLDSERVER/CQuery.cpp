...
BOOL ScriptLoadQuery( LPCSTR lpszFileName )
{
	strcpy(DB_ADMIN_PASS_CHARACTER01, "");	
	strcpy(DB_ADMIN_ID_CHARACTER01,"" );
	strcpy(DSN_NAME_CHARACTER01, "Character01");
