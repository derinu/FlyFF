...
#ifdef __DDOM
#define PACKETTYPE_DDOM_JOIN						(DWORD)0xaa000002
#define PACKETTYPE_DDOM_CAP							(DWORD)0xaa000003
#define PACKETTYPE_DDOM_KICKAT						(DWORD)0xaa000004
#define PACKETTYPE_MARKET_JOIN						(DWORD)0xaa000005
#define SNAPSHOTTYPE_DDOM_QUEUE						(WORD)0xaa0a
#define SNAPSHOTTYPE_DDOM_CAP						(WORD)0xaa0b
#define SNAPSHOTTYPE_ADDITIONAL_MOVER				(WORD)0xaa0c
#define SNAPSHOTTYPE_DDOM_SCORE						(WORD)0xaa0d
#define SNAPSHOTTYPE_DDOM_CAN_KICK_AGAIN			(WORD)0xaa0e
#define SNAPSHOTTYPE_TEXT_COLOR						(WORD)0xeaea
#define SNAPSHOTTYPE_MBS_WIREFRAME					(WORD)0xaa04
#endif

#define MASTER_PACKET_ONJOIN						(DWORD)0xaa00aaee
const BYTE MASTER_BYTE_ARENA = 0x01; //snippet_221	

#ifdef __ARENA_PARADISE
#define SNAPSHOTTYPE_ARENA_STATUS					(WORD)0xcf03
#endif

#define PACKETTYPE_PETFILTER						(DWORD)0xaa000006
...
#define	SNAPSHOTTYPE_AFKCHANGE						(WORD)0x8886
#define	SNAPSHOTTYPE_PARTYLIST						(WORD)0x8887
...
#define SNAPSHOTTYPE_ADDBARUNAPET					(WORD)0x8870
...
const BYTE BARUNA_WAKE_UP                = 0x08; // valeur du byte
const BYTE BARUNA_WAKE_UP_CANCEL        = 0x09;
